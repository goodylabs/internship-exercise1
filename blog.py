...
def index():
    ...
    if not username:
        username = u'Please log in'
    islogin = session.get('islogin')
    nav_list = [u'home',u'circles',u'settings']
    blog = {'title':'welcome to my homepage','content':'hello, nice to see you.'}
    blogtag = {'javascript':10,"python":20,"shelling":5}
